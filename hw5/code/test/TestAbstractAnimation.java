...
public class TestAbstractAnimation {
  ...
  public void testEndTimeLessThanStartTime(){
    ...
    assertEquals("end time cannot be less than or the same as the start time", a.toString());
  }
  ...
  public void testGetFullDescriptionOfRectangle(){
    Rectangle r = new Rectangle(new Position(0,0), 10, 10,new Color(255,0,0), "R");
  ...
  public void testGetFullDescriptionOfEllipse(){
    Ellipse r = new Ellipse(new Position(0,0), 10, 10,new Color(255,0,0), "E");
    Motion motion = new Motion(0, 10, new Position(5,0));
